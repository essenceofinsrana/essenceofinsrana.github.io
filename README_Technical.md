# TECHNICAL DOCUMENTATION: WEBSITE of the book ***ESSENCE of INS RANA***
>  **Looking for the book details?** For historical book abstract and publication metadata, please refer to the primary [README.md](./README.md).
...
├── robots.txt
├── sitemap_map1.xml
├── googlea7bb0cc16531cf05.html
├── 1q2w3e4r5t6y7u8i9o0p.txt
│
│  [Information files]
├── llms.txt
├── llms-full.txt
